...
<head>
    ...
    <title>Password Reset - Festalive</title>
        ...
        <div class="form-card">
            ...
            <%
                ...
                try {
                    ...
                    String checkEmailQuery = "SELECT * FROM festalive_user WHERE email = ?";
                    ...
                    if (rs.next()) {
                        // Update password
                        String updatePasswordQuery = "UPDATE festalive_user SET password = ? WHERE email = ?";
